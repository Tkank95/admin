...
@section('content')
    <div id="content" role="main" class="main">
        <div class="content container-fluid">
                        ...
                        <div class="card mb-3 mb-lg-5">
                            ...
                            <div class="card-header" id="search-filter">
                                <div class="row justify-content-between align-items-center flex-grow-1">
                                    ...
                                    @include('admin.layout.list.headerForm', ['headertitle' => 'List Expense','searchholder' => 'tên loại chi phí'])
            ...
            {{-- Add Expense Modal --}}
            <div class="modal fade" id="expenseModal" data-backdrop="static" tabindex="-1" role="dialog"
                 aria-labelledby="expenseModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <form id="addExpense">@csrf
            ...
            <div class="modal fade" id="editExpenseModal" data-backdrop="static" tabindex="-1" role="dialog"
                 aria-labelledby="editExpenseModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        <form id="editExpense">@csrf
                            <div class="modal-header">
